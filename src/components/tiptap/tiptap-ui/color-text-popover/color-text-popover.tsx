              ...
              <>
                <span
                  className={cn(
                    ...
                    "after:content-[''] after:absolute after:w-full after:h-full after:left-0 after:top-0 after:rounded-[inherit] after:box-border after:border after:border-[var(--active-highlight-color,theme(colors.gray.200))] dark:after:border-[var(--active-highlight-color,theme(colors.gray.700))] after:brightness-95 after:mix-blend-multiply dark:after:brightness-140 dark:after:mix-blend-lighten"
                  )}
                  style={
