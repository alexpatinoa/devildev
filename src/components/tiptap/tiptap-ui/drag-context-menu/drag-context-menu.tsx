...
import { selectNodeAndHideFloating } from "@/hooks/tiptap/use-floating-toolbar-visibility"
...
import { Combobox, ComboboxList } from "@/components/tiptap/tiptap-ui-primitive/combobox"
import { Separator } from "@/components/tiptap/tiptap-ui-primitive/separator"

// Tiptap UI
import { useImageDownload } from "@/components/tiptap/tiptap-ui/image-download-button"
import {
  DuplicateShortcutBadge,
  useDuplicate,
} from "@/components/tiptap/tiptap-ui/duplicate-button"
import {
  CopyToClipboardShortcutBadge,
  useCopyToClipboard,
} from "@/components/tiptap/tiptap-ui/copy-to-clipboard-button"
import {
...
import {
  ...
  useCopyAnchorLink,
} from "@/components/tiptap/tiptap-ui/copy-anchor-link-button"
import { useResetAllFormatting } from "@/components/tiptap/tiptap-ui/reset-all-formatting-button"
import { SlashCommandTriggerButton } from "@/components/tiptap/tiptap-ui/slash-command-trigger-button"

import { useText } from "@/components/tiptap/tiptap-ui/text-button"
import { useHeading } from "@/components/tiptap/tiptap-ui/heading-button"
import { useList } from "@/components/tiptap/tiptap-ui/list-button"
import { useBlockquote } from "@/components/tiptap/tiptap-ui/blockquote-button"
import { useCodeBlock } from "@/components/tiptap/tiptap-ui/code-block-button"
import { ColorMenu } from "@/components/tiptap/tiptap-ui/color-menu"
...
import type {
  ...
  MenuItemProps,
  NodeChangeData,
} from "@/components/tiptap/tiptap-ui/drag-context-menu/drag-context-menu-types"

// Icons
import { GripVerticalIcon } from "@/components/tiptap/tiptap-icons/grip-vertical-icon"
import { ChevronRightIcon } from "@/components/tiptap/tiptap-icons/chevron-right-icon"
import { Repeat2Icon } from "@/components/tiptap/tiptap-icons/repeat-2-icon"
...
export const DragContextMenu: React.FC<DragContextMenuProps> = ({
  ...
  return (
    ...
    >
      <DragHandle
        className="drag-handle transition-none [.drag-handle_&]:before:content-[''] [.drag-handle_&]:before:absolute [.drag-handle_&]:before:left-full [.drag-handle_&]:before:top-0 [.drag-handle_&]:before:w-[var(--drag-handle-main-axis-offset,16px)] [.drag-handle_&]:before:h-full [.drag-handle_&]:before:pointer-events-auto"
        editor={editor}
        ...
        >
          ...
          >
            ...
            >
              ...
              <ComboboxList className="min-w-[15rem]">
                <MenuGroup>
